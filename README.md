...
Welcome to the COTI Remix Plugin, a plugin that seamlessly integrates with the Remix IDE, enabling developers to deploy and interact with contracts on the COTI network.

## Documentation

Full documentation is available in the [COTI docs](https://docs.coti.io/coti-v2-documentation/build-on-coti/tools/remix-plugin)

---

To report an issue, please see the [issues](https://github.com/coti-io/coti-remix-plugin) tab.
